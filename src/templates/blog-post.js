      ...
      <div className='container content'>
        <div className='columns'>
          <div className='column is-10 is-offset-1'>
              ...
              <footer className='post-footer columns'>
                ...
                <div className='column content is-small'>
                  <p className='post-share'>
                    <span className='post-share-title'>
                      <strong>Share: </strong>
                    </span>
                    <a
                      target='_blank'
                      href={`https://twitter.com/intent/tweet?text=${title}&amp;url=https://robkendal.co.uk${slug}`}
                    ...
                    <a
                      target='_blank'
                      href={`https://www.facebook.com/sharer.php?u=https://robkendal.co.uk${slug}`}
                      rel='noopener noreferrer'
                    >
                      Facebook
                    </a>
                    <a
                      target='_blank'
                      href={`https://www.linkedin.com/shareArticle?mini=true&url=https://robkendal.co.uk${slug}&amp;title=${title}&amp;source="Kendal Mint Code"`}
                      rel='noopener noreferrer'
                    >
                      LinkedIn
                    </a>
            ...
            <CommentsSnippet pageUrl={slug} pageId={`ghost-${postId}`} />
      ...
      <BlogPostTemplate
        ...
        helmet={
          <Helmet titleTemplate='%s | Kendal Mint Code'>
            ...
            <meta
              property='og:url'
              content={`https://robkendal.co.uk${post.fields.slug}`}
            />
            <meta
              property='og:image'
              content={`https://robkendal.co.uk${featureImageSrc}`}
            />
            ...
            <meta
              name='twitter:data2'
              content={post.frontmatter.tags.map((tag) => `${tag},`)}
            />
